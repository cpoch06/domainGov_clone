            ...
            <ul class="flex items-center space-x-6 font-medium text-sm md:text-md" role="menubar">
                <li class="relative" x-data="{ open: false }" role="none">
                    ...
                    <div x-show="open" 
                         ...
                         class="absolute left-0 mt-2 w-52 bg-white text-[#054785] rounded-xl shadow-lg z-20 text-sm pt-0"
                         x-cloak
                         role="menu"
                         aria-orientation="vertical">
                        <div class="h-2 rounded-t-xl bg-orange-400"></div>
                        <a href="/route1" 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        <g fill="#fff" stroke="#000" transform="matrix(1.2 0 0 1.2 85.6 -522)">
                            <g stroke-linejoin="bevel">
                                ...
                                <path stroke-width="0.9" d="M139 625.7h113.8v4.3H139z"></path>
                                <path
                                ...
                                <path stroke-linejoin="miter"
                                    d="M94.5 669.5a9.3 9.3 0 0 0 4.4-5.3H292a9.3 9.3 0 0 0 4.4 5.3z"></path>
                            </g>
                            <path
